      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/super/lihat-user"><i class="fa fa-circle-o"></i> Lihat Data</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-user"></i> <span>Manajemen kriteria</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/super/lihat-kriteria"><i class="fa fa-circle-o"></i> Lihat Data</a></li>
          </ul>
        </li>
         <li class="treeview">
          <a href="/super/lihat_logs">
